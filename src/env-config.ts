...
export const AWS_ATHENA_OPTION_ENCRYPTION_ENABLED = process.env["AWS_ATHENA_OPTION_ENCRYPTION_ENABLED"]
export const AWS_ATHENA_OPTION_ENCRYPTION_TYPE = process.env["AWS_ATHENA_OPTION_ENCRYPTION_TYPE"] ?? "SSE_KMS"
export const AWS_ATHENA_OPTION_ENCRYPTION_KEY = process.env["AWS_ATHENA_OPTION_ENCRYPTION_KEY"] ?? "KmsKey"
export const AWS_ATHENA_OPTION_ENCRYPTION_VALUE = process.env["AWS_ATHENA_OPTION_ENCRYPTION_VALUE"] ?? ""
